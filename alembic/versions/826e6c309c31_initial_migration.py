...
def upgrade():
    ...
    sa.Column('registered', sa.DateTime(), server_default=sa.text("timezone('utc', current_timestamp)"), nullable=False),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('studio_id', postgresql.UUID(), nullable=False),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('admin_id', postgresql.UUID(), nullable=False),
    sa.Column('genres', sa.Unicode(), server_default='', nullable=False),
    sa.Column('staff_notes', sa.Unicode(), server_default='', nullable=False),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('game_id', postgresql.UUID(), nullable=False),
    sa.Column('judge_id', postgresql.UUID(), nullable=True),
    ...
    sa.Column('id', postgresql.UUID(), nullable=False),
    sa.Column('game_id', postgresql.UUID(), nullable=False),
    sa.Column('judge_id', postgresql.UUID(), nullable=False),
